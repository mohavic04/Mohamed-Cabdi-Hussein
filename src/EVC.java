...
public class EVC {
    public static void main(String[] args) {
        ...
        final int ACCOUNT_NUMBER = 4937336;
        final int BUSINESS_ID = 7890;
        // Initial balances
        int mobileBalance = 3000;
            ...
            case 6:
                ...
                if (bankOption == 1) {
                    ...
                    if (manageChoice == 1) {
                        ...
                        int BANK_PIN = 7890;
                        System.out.println("Fadlan Geli Numberkaaga sirta ee Bangiga");
                        int enteredPine = inputReader.nextInt();
            ...
            case 8:
                ...
                if (taajOption == 1) {
                    ...
                    if (companyChoice == 1) {
                        ...
                        String recipientCity = inputReader.nextLine();
                        System.out.println("Fadlan Geli Lacagta");
                        int transferValueu = inputReader.nextInt();
                        System.out.println("Fadlan Geli Macluumaad");
                    ...
                    if (transferInfo != transferId) {
                        System.out.println("Invalid Input matchlength");
                        break;
                    } else {
                        System.out.println("Mahubtaa in aad xirto aqoonsiga xawilaada " + transferId + "?");
                        System.out.println("1. Haa");
